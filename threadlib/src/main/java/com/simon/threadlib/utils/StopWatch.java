...
package com.simon.threadlib.utils;
...
//        return "MethodWatch '" + this.id + "': running time (millis) = " + getTotalTimeMillis();
        return "MethodWatch: ";
    }
    ...
    public String prettyPrint() {
        ...
        if (!this.keepTaskList) {
            ...
            sb.append("|   cost  time:    ");
            sb.append(task.getTimeMillis() + " ms").append("\n");
            sb.append("-----------------------------------------\n");
        }
        return sb.toString();
    }
